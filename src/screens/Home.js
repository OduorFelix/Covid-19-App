			...
			<View style={styles.container}>
				<ImageBackground source={require('../images/unnamed.jpg')} style={styles.map}>
					...
					<View style={styles.colContainer}>
						...
						<Text style={styles.textRussia}>KENYA</Text>
				...
				<ScrollView style={{ marginTop: 170 }} showsHorizontalScrollIndicator={false} horizontal>
					<Cards
						...
						number="113 329"
					/>
					<Cards icon="ios-git-network" title="RECOVERED" bg="#FFF" number="442 329" />
					<Cards icon="ios-heart-dislike" title="DEATH CASES" bg="#FFF" number="113 329" />
				</ScrollView>
